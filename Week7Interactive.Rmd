...
To run R and RStudio for this workshop on Binder (with all packages pre-installed), click on this badge - [![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/IdoBar/6003ESC_Workshop4/T1_2021?urlpath=rstudio){target="_blank"}.
